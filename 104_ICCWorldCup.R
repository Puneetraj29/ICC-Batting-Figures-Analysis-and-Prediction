...
# Data Cleaning / Data Wrangling Lab

install.packages("tidyverse")
library(tidyverse)

#read the csv file into object df
#setting stringsAsFactors = FALSE will prevent 
#conversion of character data into Factor data while reading csv file
...
df %>% summarise(count = sum(is.na(Innings_Batted)))
  ...
  #There are 93 missing/null values in Innings_Batted   
...
df %>% summarise(count = sum(is.na(Not_Outs)))
    ...
    #There are 93 missing/null values in Not_Outs   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Runs_Scored)))
    ...
    #There are 93 missing/null values in  Runs_Scored   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Highest_Innings_Score)))
    ...
    #There are 882 missing/null values in  Highest_Innings_Score   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Batting_Average)))
    ...
    #There are 213 missing/null values in  Batting_Average   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Balls_Faced)))
    ...
    #There are 93 missing/null values in  Balls_Faced   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Batting_Strike_Rate)))
    ...
    #There are 102 missing/null values in  Batting_Strike_Rate   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Hundreds_Scored)))
    ...
    #There are 93 missing/null values in  Hundreds_Scored   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Runs_Scored_above_50_or._50)))
    ...
    #There are 93 missing/null values in  Runs_Scored_above_50_or._50   
    #Therefore we replace the missing values with mean
...
df %>% summarise(count = sum(is.na( Ducks_Scored )))
    ...
    #There are 93 missing/null values in  Ducks_Scored    
    #Therefore we replace the missing values with mean
